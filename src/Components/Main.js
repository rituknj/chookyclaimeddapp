  ...
  return (
    <section >
      ...
      <div >
        ...
        <div className="row">
        <div className="col-lg-6 col-md-6 col-sm-6 col-12"> <div className="main-content">
        <p style={{color:'#fff'}}>Your Chooky Balance:</p>

        </div></div>
        <div className="col-lg-6 col-md-6 col-sm-6 col-12"> <div className="main-content">
        <p style={{color:'#fff'}}>_____________________________<button className="chooky-button">Chooky</button></p>
        ...
        <button className="claim-bu"> CLAIM</button></div>
